    ...
    <div className={classes.root}>
     ...
     {weatherWeek?.map(day=>( <Accordion>
        ...
        >
          ...
          <img src={`https://darksky.net/images/weather-icons/${day.icon}.png`} alt="weather Icon" style={{width:'20px', marginRight:'10px'}}/>
          <Moment  unix format="dddd" >{day.time}</Moment> :  
          
              <span> Min:{(((day.temperatureMin-32)*5)/9).toFixed(1)}° </span>
             || <span> Max:{(((day.temperatureMin-32)*5)/9).toFixed(1)}° </span>
        ...
        <AccordionDetails>
          <Typography> 
            <div style={{display:'flex',justifyContent:'center'}}>
               ...
               Wind:
                 </p>  {day.windSpeed} mph <br />
                 
                 <p style={{fontWeight:800}}>
               Humidity:
                 </p>  {day.humidity*100}% <br />
                 <p style={{fontWeight:800}}>
               Dew Point:
                 </p> {day.dewPoint} <br />
                 <p style={{fontWeight:800}}>
               UV Index:
                 ...
                 <p style={{fontWeight:800}}>
               Visibility:
                 </p>  {day.visibility} mi <br />
                 <p style={{fontWeight:800}}>
               Pressure:
                 </p>  {day.pressure} mb <br />
                </div>
            </div>
